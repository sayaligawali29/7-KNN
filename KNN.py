# -*- coding: utf-8 -*-
"""
Created on Tue Jan 30 15:00:17 2024
...
#There are 569 rows and 32 column
wbcd.describe()
# in output column there is only B for Benien and M for Malignant
#let us first convert it is Benign and Malignant
wbcd['diagnosis']=np.where(wbcd['diagnosis']=='B','Beniegn',wbcd['diagnosis'])
#In wbcd there is column named 'diagnosis where ever there is 'B' replace 
#Benign
#Similarly where ever there is M in the ame column replace with 'Malignant
...
#because now 0th column is output or label it is not considered hence 1:
    ####################
...
#Actual patient is Benien and predicted as cancer patirnt is 2
#hence this model is not acceptable
#for 5 same sinario
